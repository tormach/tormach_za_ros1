...
class Configuration:
    ...
    def __init__(
        self,
        host="https://hub.pathpilot.com/api/v1",
        api_key=None,
        api_key_prefix=None,
        username=None,
        password=None,
    ...
    def auth_settings(self):
        ...
        """
        auth = {}
        if 'X-HubAuthToken' in self.api_key:
            auth['HubTokenAuth'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'X-HubAuthToken',
                'value': self.get_api_key_with_prefix('X-HubAuthToken'),
            }
        return auth
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "https://hub.pathpilot.com/api/v1",
