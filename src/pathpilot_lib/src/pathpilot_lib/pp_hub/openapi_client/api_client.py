...
class ApiClient:
    ...
    def close(self):
        # sigh - the RESTClientObject() has a urllib3.PoolManager that it is
        # never cleaning up...added this method to do so.
        self.rest_client.close()

        if self._pool:
            # this leads to ugly blocking waiting for half dead connections to wrap up
            # self._pool.close()
            # self._pool.join()
    ...
    def __deserialize_file(self, response):
        ...
        if content_disposition:
            #
            # The regex is always wrong in the generated openapi client code.
            # It fails on file names containing spaces.
            #
            filename = re.search(
