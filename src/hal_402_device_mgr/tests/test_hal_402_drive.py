...
class TestDrive402IS620Init(TestDrive402Base):
    ...
    def test___init__(self, mock_halcomp):
        ...
        assert obj.drive_type == self.drive_type
...
class TestDrive402SV660Init(TestDrive402IS620Init):
    drive_type = 'inovance_sv660n'


class TestDrive402IS620(TestDrive402Base):
    init_fixture_obj = True
    drive_type = 'inovance_is620n'
    ...
    def test_get_error_info(self, obj, ros_params):
        err_info = ros_params['device_fault_code_list'][self.drive_type][
            '0x0101'
        ]
        assert (
...
class TestDrive402SV660(TestDrive402IS620):
    drive_type = 'inovance_sv660n'
