...
from hal_402_device_mgr_msgs.msg import msg_error
...
class Drive402:
    ...
    def sim_fake_next_inputs(self):
        ...
        self.pins.status_word_sim.set(status_word)
        self.pins.status_word_sim.write()
    ...
    def voltage_enabled(self):
        return self.sm402.voltage_enabled
